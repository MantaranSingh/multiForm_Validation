...
<div class="card">
    ...
    <button type="submit" id="submitBtn" class="btn btn-primary">Enter OTP</button>
    <div id="otp" class="form-group" style="display: none;">
        <input type="number" name="otp" class="form-control" required autocomplete="off" placeholder="Enter OTP">
        <div class="invalid-feedback">
            <small>Please provide a valid OTP number.</small>
        </div>
    </div>
    </form>
</div>
        ...
        submitBtn.addEventListener("click", function (event) {
            ...
            if (element.value == 'netBanking') {
                ...
                if (validNumber && validName) {
                    ...
                    let input = otp.querySelector('input')
